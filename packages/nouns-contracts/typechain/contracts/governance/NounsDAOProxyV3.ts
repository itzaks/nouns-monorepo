...
export interface NounsDAOProxyV3Interface extends utils.Interface {
  functions: {
...
export interface NounsDAOProxyV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NounsDAOProxyV3Interface;
