...
export declare namespace NounsDAOStorageV3 {
  ...
  export type ProposerSignatureStructOutput = [string, string, BigNumber] & {
    sig: string;
    signer: string;
...
export interface NounsDAOLogicV3Interface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "withdrawDAONounsFromEscrowIncreasingTotalSupply",
    values: [BigNumberish[], string]
  ): string;
  encodeFunctionData(
    functionFragment: "withdrawDAONounsFromEscrowToTreasury",
    values: [BigNumberish[]]
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "DAONounsSupplyIncreasedFromEscrow"
  ): EventFragment;
  getEvent(nameOrSignatureOrTopic: "DAOWithdrawNounsFromEscrow"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "ERC20TokensToIncludeInForkSet"
  ): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "ProposalCreatedOnTimelockV1"
  ): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "ProposalCreatedWithRequirements(uint256,address,address[],address[],uint256[],string[],bytes[],uint256,uint256,uint256,uint256,uint256,string)"
  ): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "ProposalCreatedWithRequirements(uint256,address,address[],uint256[],string[],bytes[],uint256,uint256,uint256,uint256,string)"
  ): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "ProposalTransactionsUpdated"
  ): EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "VoteSnapshotBlockSwitchProposalIdSet"
  ): EventFragment;
...
export type DAONounsSupplyIncreasedFromEscrowEvent = TypedEvent<
  [BigNumber, string],
  DAONounsSupplyIncreasedFromEscrowEventObject
>;

export type DAONounsSupplyIncreasedFromEscrowEventFilter =
  TypedEventFilter<DAONounsSupplyIncreasedFromEscrowEvent>;

export interface DAOWithdrawNounsFromEscrowEventObject {
  tokenIds: BigNumber[];
  to: string;
}
export type DAOWithdrawNounsFromEscrowEvent = TypedEvent<
  [BigNumber[], string],
  DAOWithdrawNounsFromEscrowEventObject
>;

export type DAOWithdrawNounsFromEscrowEventFilter =
  TypedEventFilter<DAOWithdrawNounsFromEscrowEvent>;

export interface ERC20TokensToIncludeInForkSetEventObject {
  oldErc20Tokens: string[];
  newErc20tokens: string[];
}
export type ERC20TokensToIncludeInForkSetEvent = TypedEvent<
  [string[], string[]],
  ERC20TokensToIncludeInForkSetEventObject
>;

export type ERC20TokensToIncludeInForkSetEventFilter =
  TypedEventFilter<ERC20TokensToIncludeInForkSetEvent>;
...
export type EscrowedToForkEvent = TypedEvent<
  [number, string, BigNumber[], BigNumber[], string],
  EscrowedToForkEventObject
>;

export type EscrowedToForkEventFilter = TypedEventFilter<EscrowedToForkEvent>;
...
export type ExecuteForkEvent = TypedEvent<
  [number, string, string, BigNumber, BigNumber],
  ExecuteForkEventObject
>;

export type ExecuteForkEventFilter = TypedEventFilter<ExecuteForkEvent>;

export interface ForkDAODeployerSetEventObject {
  oldForkDAODeployer: string;
  newForkDAODeployer: string;
}
export type ForkDAODeployerSetEvent = TypedEvent<
  [string, string],
  ForkDAODeployerSetEventObject
>;

export type ForkDAODeployerSetEventFilter =
  TypedEventFilter<ForkDAODeployerSetEvent>;

export interface ForkPeriodSetEventObject {
  oldForkPeriod: BigNumber;
  newForkPeriod: BigNumber;
}
export type ForkPeriodSetEvent = TypedEvent<
  [BigNumber, BigNumber],
  ForkPeriodSetEventObject
>;

export type ForkPeriodSetEventFilter = TypedEventFilter<ForkPeriodSetEvent>;

export interface ForkThresholdSetEventObject {
  oldForkThreshold: BigNumber;
  newForkThreshold: BigNumber;
}
export type ForkThresholdSetEvent = TypedEvent<
  [BigNumber, BigNumber],
  ForkThresholdSetEventObject
>;

export type ForkThresholdSetEventFilter =
  TypedEventFilter<ForkThresholdSetEvent>;
...
export type JoinForkEvent = TypedEvent<
  [number, string, BigNumber[], BigNumber[], string],
  JoinForkEventObject
>;

export type JoinForkEventFilter = TypedEventFilter<JoinForkEvent>;

export interface LastMinuteWindowSetEventObject {
  oldLastMinuteWindowInBlocks: number;
  newLastMinuteWindowInBlocks: number;
}
export type LastMinuteWindowSetEvent = TypedEvent<
  [number, number],
  LastMinuteWindowSetEventObject
>;

export type LastMinuteWindowSetEventFilter =
  TypedEventFilter<LastMinuteWindowSetEvent>;
...
export type ObjectionPeriodDurationSetEvent = TypedEvent<
  [number, number],
  ObjectionPeriodDurationSetEventObject
>;

export type ObjectionPeriodDurationSetEventFilter =
  TypedEventFilter<ObjectionPeriodDurationSetEvent>;
...
export type ProposalCreatedOnTimelockV1Event = TypedEvent<
  [BigNumber],
  ProposalCreatedOnTimelockV1EventObject
>;

export type ProposalCreatedOnTimelockV1EventFilter =
  TypedEventFilter<ProposalCreatedOnTimelockV1Event>;
...
export type ProposalCreatedWithRequirements_uint256_address_address_array_address_array_uint256_array_string_array_bytes_array_uint256_uint256_uint256_uint256_uint256_string_Event =
  TypedEvent<
    [
      BigNumber,
      string,
...
export type ProposalCreatedWithRequirements_uint256_address_address_array_address_array_uint256_array_string_array_bytes_array_uint256_uint256_uint256_uint256_uint256_string_EventFilter =
  TypedEventFilter<ProposalCreatedWithRequirements_uint256_address_address_array_address_array_uint256_array_string_array_bytes_array_uint256_uint256_uint256_uint256_uint256_string_Event>;
...
export type ProposalCreatedWithRequirements_uint256_address_address_array_uint256_array_string_array_bytes_array_uint256_uint256_uint256_uint256_string_Event =
  TypedEvent<
    [
      BigNumber,
      string,
...
export type ProposalCreatedWithRequirements_uint256_address_address_array_uint256_array_string_array_bytes_array_uint256_uint256_uint256_uint256_string_EventFilter =
...
export type ProposalDescriptionUpdatedEvent = TypedEvent<
  [BigNumber, string, string, string],
  ProposalDescriptionUpdatedEventObject
>;

export type ProposalDescriptionUpdatedEventFilter =
  TypedEventFilter<ProposalDescriptionUpdatedEvent>;
...
export type ProposalObjectionPeriodSetEvent = TypedEvent<
  [BigNumber, BigNumber],
  ProposalObjectionPeriodSetEventObject
>;

export type ProposalObjectionPeriodSetEventFilter =
  TypedEventFilter<ProposalObjectionPeriodSetEvent>;
...
export type ProposalTransactionsUpdatedEvent = TypedEvent<
  [BigNumber, string, string[], BigNumber[], string[], string[], string],
  ProposalTransactionsUpdatedEventObject
>;

export type ProposalTransactionsUpdatedEventFilter =
  TypedEventFilter<ProposalTransactionsUpdatedEvent>;
...
export type ProposalUpdatablePeriodSetEvent = TypedEvent<
  [number, number],
  ProposalUpdatablePeriodSetEventObject
>;

export type ProposalUpdatablePeriodSetEventFilter =
  TypedEventFilter<ProposalUpdatablePeriodSetEvent>;
...
export type SignatureCancelledEvent = TypedEvent<
  [string, string],
  SignatureCancelledEventObject
>;

export type SignatureCancelledEventFilter =
  TypedEventFilter<SignatureCancelledEvent>;
...
export type TimelocksAndAdminSetEvent = TypedEvent<
  [string, string, string],
  TimelocksAndAdminSetEventObject
>;

export type TimelocksAndAdminSetEventFilter =
  TypedEventFilter<TimelocksAndAdminSetEvent>;
...
export type VoteSnapshotBlockSwitchProposalIdSetEvent = TypedEvent<
  [BigNumber, BigNumber],
  VoteSnapshotBlockSwitchProposalIdSetEventObject
>;

export type VoteSnapshotBlockSwitchProposalIdSetEventFilter =
  TypedEventFilter<VoteSnapshotBlockSwitchProposalIdSetEvent>;
...
export type WithdrawFromForkEscrowEvent = TypedEvent<
  [number, string, BigNumber[]],
  WithdrawFromForkEscrowEventObject
>;

export type WithdrawFromForkEscrowEventFilter =
  TypedEventFilter<WithdrawFromForkEscrowEvent>;

export interface NounsDAOLogicV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NounsDAOLogicV3Interface;
  ...
  functions: {
    ...
    _setForkParams(
      forkEscrow_: string,
      forkDAODeployer_: string,
      erc20TokensToIncludeInFork_: string[],
    ...
    dynamicQuorumVotes(
      againstVotes: BigNumberish,
      adjustedTotalSupply_: BigNumberish,
      params: NounsDAOStorageV3.DynamicQuorumParamsStruct,
    ...
    getDynamicQuorumParamsAt(
      ...
      overrides?: CallOverrides
    ): Promise<[NounsDAOStorageV3.DynamicQuorumParamsStructOutput]>;

    getReceipt(
      proposalId: BigNumberish,
      voter: string,
      overrides?: CallOverrides
    ): Promise<[NounsDAOStorageV3.ReceiptStructOutput]>;
    ...
    proposalsV3(
      proposalId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[NounsDAOStorageV3.ProposalCondensedStructOutput]>;
    ...
    "quorumParamsCheckpoints()"(
      overrides?: CallOverrides
    ): Promise<[NounsDAOStorageV3.DynamicQuorumParamsCheckpointStructOutput[]]>;
  ...
  callStatic: {
    ...
    executeFork(
      overrides?: CallOverrides
    ): Promise<[string, string] & { forkTreasury: string; forkToken: string }>;
  ...
  filters: {
    "DAONounsSupplyIncreasedFromEscrow(uint256,address)"(
      numTokens?: null,
      to?: null
    ): DAONounsSupplyIncreasedFromEscrowEventFilter;
    DAONounsSupplyIncreasedFromEscrow(
      numTokens?: null,
      to?: null
    ): DAONounsSupplyIncreasedFromEscrowEventFilter;

    "DAOWithdrawNounsFromEscrow(uint256[],address)"(
      tokenIds?: null,
      to?: null
    ): DAOWithdrawNounsFromEscrowEventFilter;
    DAOWithdrawNounsFromEscrow(
      tokenIds?: null,
      to?: null
    ): DAOWithdrawNounsFromEscrowEventFilter;

    "ERC20TokensToIncludeInForkSet(address[],address[])"(
      oldErc20Tokens?: null,
      newErc20tokens?: null
    ): ERC20TokensToIncludeInForkSetEventFilter;
    ERC20TokensToIncludeInForkSet(
      oldErc20Tokens?: null,
      newErc20tokens?: null
    ): ERC20TokensToIncludeInForkSetEventFilter;

    "EscrowedToFork(uint32,address,uint256[],uint256[],string)"(
      forkId?: BigNumberish | null,
      owner?: string | null,
      tokenIds?: null,
      proposalIds?: null,
      reason?: null
    ): EscrowedToForkEventFilter;
    EscrowedToFork(
      forkId?: BigNumberish | null,
      owner?: string | null,
      tokenIds?: null,
    ...
    "ExecuteFork(uint32,address,address,uint256,uint256)"(
      forkId?: BigNumberish | null,
      forkTreasury?: null,
      forkToken?: null,
      forkEndTimestamp?: null,
      tokensInEscrow?: null
    ): ExecuteForkEventFilter;
    ExecuteFork(
      forkId?: BigNumberish | null,
      forkTreasury?: null,
      forkToken?: null,
    ...
    "ForkDAODeployerSet(address,address)"(
      oldForkDAODeployer?: null,
      newForkDAODeployer?: null
    ): ForkDAODeployerSetEventFilter;
    ForkDAODeployerSet(
      oldForkDAODeployer?: null,
      newForkDAODeployer?: null
    ): ForkDAODeployerSetEventFilter;

    "ForkPeriodSet(uint256,uint256)"(
      oldForkPeriod?: null,
      newForkPeriod?: null
    ): ForkPeriodSetEventFilter;
    ForkPeriodSet(
      oldForkPeriod?: null,
      newForkPeriod?: null
    ): ForkPeriodSetEventFilter;

    "ForkThresholdSet(uint256,uint256)"(
      oldForkThreshold?: null,
      newForkThreshold?: null
    ): ForkThresholdSetEventFilter;
    ForkThresholdSet(
      oldForkThreshold?: null,
      newForkThreshold?: null
    ): ForkThresholdSetEventFilter;

    "JoinFork(uint32,address,uint256[],uint256[],string)"(
      forkId?: BigNumberish | null,
      owner?: string | null,
      tokenIds?: null,
      proposalIds?: null,
    ...
    "LastMinuteWindowSet(uint32,uint32)"(
      oldLastMinuteWindowInBlocks?: null,
      newLastMinuteWindowInBlocks?: null
    ): LastMinuteWindowSetEventFilter;
    LastMinuteWindowSet(
      oldLastMinuteWindowInBlocks?: null,
      newLastMinuteWindowInBlocks?: null
    ): LastMinuteWindowSetEventFilter;
    ...
    "ObjectionPeriodDurationSet(uint32,uint32)"(
      oldObjectionPeriodDurationInBlocks?: null,
      newObjectionPeriodDurationInBlocks?: null
    ): ObjectionPeriodDurationSetEventFilter;
    ...
    "ProposalCreatedOnTimelockV1(uint256)"(
      id?: null
    ): ProposalCreatedOnTimelockV1EventFilter;
    ...
    "ProposalCreatedWithRequirements(uint256,address,address[],address[],uint256[],string[],bytes[],uint256,uint256,uint256,uint256,uint256,string)"(
      ...
      startBlock?: null,
      endBlock?: null,
      updatePeriodEndBlock?: null,
      proposalThreshold?: null,
      quorumVotes?: null,
      description?: null
    ): ProposalCreatedWithRequirements_uint256_address_address_array_address_array_uint256_array_string_array_bytes_array_uint256_uint256_uint256_uint256_uint256_string_EventFilter;
    "ProposalCreatedWithRequirements(uint256,address,address[],uint256[],string[],bytes[],uint256,uint256,uint256,uint256,string)"(
      ...
      quorumVotes?: null,
      description?: null
    ): ProposalCreatedWithRequirements_uint256_address_address_array_uint256_array_string_array_bytes_array_uint256_uint256_uint256_uint256_string_EventFilter;

    "ProposalDescriptionUpdated(uint256,address,string,string)"(
      id?: BigNumberish | null,
      proposer?: string | null,
      description?: null,
      updateMessage?: null
    ): ProposalDescriptionUpdatedEventFilter;
    ...
    "ProposalObjectionPeriodSet(uint256,uint256)"(
      id?: BigNumberish | null,
      objectionPeriodEndBlock?: null
    ): ProposalObjectionPeriodSetEventFilter;
    ...
    "ProposalTransactionsUpdated(uint256,address,address[],uint256[],string[],bytes[],string)"(
      id?: BigNumberish | null,
      proposer?: string | null,
      targets?: null,
      values?: null,
      ...
      calldatas?: null,
      updateMessage?: null
    ): ProposalTransactionsUpdatedEventFilter;
    ...
    "ProposalUpdatablePeriodSet(uint32,uint32)"(
      oldProposalUpdatablePeriodInBlocks?: null,
      newProposalUpdatablePeriodInBlocks?: null
    ): ProposalUpdatablePeriodSetEventFilter;
    ProposalUpdatablePeriodSet(
      oldProposalUpdatablePeriodInBlocks?: null,
      newProposalUpdatablePeriodInBlocks?: null
    ): ProposalUpdatablePeriodSetEventFilter;

    "ProposalUpdated(uint256,address,address[],uint256[],string[],bytes[],string,string)"(
      id?: BigNumberish | null,
      proposer?: string | null,
      targets?: null,
      values?: null,
    ...
    "SignatureCancelled(address,bytes)"(
      signer?: string | null,
      sig?: null
    ): SignatureCancelledEventFilter;
    SignatureCancelled(
      signer?: string | null,
      sig?: null
    ): SignatureCancelledEventFilter;

    "TimelocksAndAdminSet(address,address,address)"(
      timelock?: null,
      timelockV1?: null,
      admin?: null
    ): TimelocksAndAdminSetEventFilter;
    ...
    "VoteSnapshotBlockSwitchProposalIdSet(uint256,uint256)"(
      oldVoteSnapshotBlockSwitchProposalId?: null,
      newVoteSnapshotBlockSwitchProposalId?: null
    ): VoteSnapshotBlockSwitchProposalIdSetEventFilter;
    ...
    "WithdrawFromForkEscrow(uint32,address,uint256[])"(
      forkId?: BigNumberish | null,
      owner?: string | null,
      tokenIds?: null
    ): WithdrawFromForkEscrowEventFilter;
    WithdrawFromForkEscrow(
      forkId?: BigNumberish | null,
      owner?: string | null,
      tokenIds?: null
