...
export interface NounsDAOV3AdminInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "MAX_FORK_PERIOD",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_OBJECTION_PERIOD_BLOCKS",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "MAX_UPDATABLE_PERIOD_BLOCKS",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_VOTING_DELAY_BLOCKS",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_VOTING_PERIOD_BLOCKS",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MIN_FORK_PERIOD",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "MIN_VOTING_DELAY_BLOCKS",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type ForkEscrowSetEvent = TypedEvent<
  [string, string],
  ForkEscrowSetEventObject
>;

export type ForkEscrowSetEventFilter = TypedEventFilter<ForkEscrowSetEvent>;
...
export interface NounsDAOV3Admin extends BaseContract {
  ...
  filters: {
    ...
    "ForkEscrowSet(address,address)"(
      oldForkEscrow?: null,
      newForkEscrow?: null
    ): ForkEscrowSetEventFilter;
    ForkEscrowSet(
      oldForkEscrow?: null,
      newForkEscrow?: null
    ): ForkEscrowSetEventFilter;
