...
export interface NounsTokenForkInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "claimDuringForkPeriod",
    values: [string, BigNumberish[]]
  ): string;
  encodeFunctionData(
    functionFragment: "claimFromEscrow",
    values: [BigNumberish[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "forkingPeriodEndTimestamp",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "remainingTokensToClaim",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface NounsTokenFork extends BaseContract {
  ...
  functions: {
    ...
    initialize(
      ...
      _minter: string,
      _escrow: string,
      _forkId: BigNumberish,
      startNounId: BigNumberish,
      tokensToClaim: BigNumberish,
      _forkingPeriodEndTimestamp: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
