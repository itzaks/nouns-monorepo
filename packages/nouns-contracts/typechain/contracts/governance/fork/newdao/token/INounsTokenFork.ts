...
export interface INounsTokenForkInterface extends utils.Interface {
  functions: {
...
export interface INounsTokenFork extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: INounsTokenForkInterface;
