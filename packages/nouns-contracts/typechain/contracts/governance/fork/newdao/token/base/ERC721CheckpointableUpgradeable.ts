...
export interface ERC721CheckpointableUpgradeableInterface
...
export interface ERC721CheckpointableUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721CheckpointableUpgradeableInterface;
