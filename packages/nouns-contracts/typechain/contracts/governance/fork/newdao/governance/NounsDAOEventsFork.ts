...
export interface NounsDAOEventsForkInterface extends utils.Interface {
  functions: {};
...
export interface NounsDAOEventsFork extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NounsDAOEventsForkInterface;
