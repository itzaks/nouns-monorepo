...
export interface NounsDAOLogicV1ForkInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "_acceptAdmin"
      | "_proposals"
      | "_setErc20TokensToIncludeInQuit"
      | "_setPendingAdmin"
      ...
      | "castVoteBySig"
      | "castVoteWithReason"
      | "delayedGovernanceExpirationTimestamp"
      | "erc20TokensToIncludeInQuit"
      | "erc20TokensToIncludeInQuitArray"
      | "execute"
      | "getActions"
      | "getReceipt"
      | "initialize"
  ...
  encodeFunctionData(
    functionFragment: "_setErc20TokensToIncludeInQuit",
    values: [string[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "delayedGovernanceExpirationTimestamp",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "erc20TokensToIncludeInQuit",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "erc20TokensToIncludeInQuitArray",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "quit(uint256[],address[])",
    values: [BigNumberish[], string[]]
  ): string;
  encodeFunctionData(
    functionFragment: "quit(uint256[])",
    values: [BigNumberish[]]
  ): string;
  encodeFunctionData(
  ...
  getEvent(
    nameOrSignatureOrTopic: "ERC20TokensToIncludeInQuitSet"
  ): EventFragment;
...
export type ERC20TokensToIncludeInQuitSetEvent = TypedEvent<
  [string[], string[]],
  ERC20TokensToIncludeInQuitSetEventObject
>;

export type ERC20TokensToIncludeInQuitSetEventFilter =
  TypedEventFilter<ERC20TokensToIncludeInQuitSetEvent>;
...
export type QuitEvent = TypedEvent<[string, BigNumber[]], QuitEventObject>;
...
export interface NounsDAOLogicV1Fork extends BaseContract {
  ...
  functions: {
    ...
    getReceipt(
      ...
      voter: string,
      overrides?: CallOverrides
    ): Promise<[NounsDAOStorageV1Fork.ReceiptStructOutput]>;
    ...
    initialize(
      ...
      erc20TokensToIncludeInQuit_: string[],
      delayedGovernanceExpirationTimestamp_: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    proposals(
      proposalId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[NounsDAOStorageV1Fork.ProposalCondensedStructOutput]>;
  ...
  filters: {
    ...
    "ERC20TokensToIncludeInQuitSet(address[],address[])"(
      oldErc20Tokens?: null,
      newErc20tokens?: null
    ): ERC20TokensToIncludeInQuitSetEventFilter;
    ERC20TokensToIncludeInQuitSet(
      oldErc20Tokens?: null,
      newErc20tokens?: null
    ): ERC20TokensToIncludeInQuitSetEventFilter;
