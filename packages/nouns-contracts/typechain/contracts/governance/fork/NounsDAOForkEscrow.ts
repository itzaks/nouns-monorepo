...
export interface NounsDAOForkEscrowInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "currentOwnerOf"
      | "dao"
      | "escrowedTokensByForkId"
      | "forkId"
      | "nounsToken"
      | "numTokensInEscrow"
      | "numTokensOwnedByDAO"
      | "onERC721Received"
      | "ownerOfEscrowedToken"
      | "returnTokensToOwner"
      | "withdrawTokens"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "closeEscrow",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "currentOwnerOf",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "dao", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "escrowedTokensByForkId",
  ...
  encodeFunctionData(
    functionFragment: "numTokensInEscrow",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "numTokensOwnedByDAO",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "ownerOfEscrowedToken",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
