...
export interface ForkDAODeployerInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "delayedGovernanceMaxDuration",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "deployForkDAO",
  ...
  encodeFunctionData(
    functionFragment: "initialProposalThresholdBPS",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "initialQuorumVotesBPS",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "initialVotingDelay",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "initialVotingPeriod",
    values?: undefined
  ): string;
...
export interface ForkDAODeployer extends BaseContract {
  ...
  functions: {
    ...
    deployForkDAO(
      forkingPeriodEndTimestamp: BigNumberish,
      forkEscrow: string,
  ...
  callStatic: {
    ...
    deployForkDAO(
      ...
      forkEscrow: string,
      overrides?: CallOverrides
    ): Promise<[string, string] & { treasury: string; token: string }>;
